...
{
    // boot args
    const char *boot_args = "kextlog=0xfff debug=0x8 cpus=1 rd=disk0s1 serial=1 wlan.log.flags=0xffffffff wlan.log.level=7 amfi_allow_any_signature=1 -v                   "; // if not const then overwritten
